...
/// <summary>
/// Legacy Blowfish encryption implementation
/// Reference: XIVLauncher.Common.Encryption.LegacyBlowfish
/// SE's implementation has a bug: uses signed numbers during key initialization
/// </summary>
public class LegacyBlowfish
{
    ...
    private IEnumerable<(int, uint)> WrappingUInt32(IEnumerable<byte> source, int count)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            {
                // NOTE: SE's implementation incorrectly uses signed numbers, we need to maintain compatibility
                n = (uint)((n << 8) | (sbyte)enumerator.Current);
            }
