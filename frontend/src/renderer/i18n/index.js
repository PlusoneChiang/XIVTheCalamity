...
const translations = {
  'zh-TW': {
    ...
    'settings.discord_rpc.enabled': '啟用遊戲內 Discord Rich Presence',
    'settings.discord_rpc.enabled_help': '啟用後由遊戲內 Dalamud.RichPresence 作為活動來源（需先儲存/套用）',
    'settings.discord_rpc.auto_install': '啟動遊戲前自動安裝/修復',
    'settings.discord_rpc.auto_install_help': '啟動前自動檢查並修復 bridge',
    'settings.discord_rpc.install_button': '安裝/修復 Bridge',
    'settings.discord_rpc.installing': '正在安裝 Discord RPC Bridge...',
    'settings.discord_rpc.install_success': 'Discord RPC Bridge 安裝成功',
    'settings.discord_rpc.install_failed': 'Discord RPC Bridge 安裝失敗',
    'settings.discord_rpc.status_unknown': '狀態：尚未檢查',
    'settings.discord_rpc.status_unsupported': '狀態：目前平台不支援',
    'settings.discord_rpc.status_disabled': '狀態：已停用',
    'settings.discord_rpc.status_ready': '狀態：已就緒',
    'settings.discord_rpc.status_needs_install': '狀態：需要安裝或修復',
    'settings.discord_rpc.status_pending_apply': '狀態：請先儲存/套用設定後再安裝或修復',
    ...
    'settings.wine.ime_section': '輸入法設定',
    'settings.wine.ime_pos_x': '候選字視窗 X 位置 (%)',
    'settings.wine.ime_pos_x_help': '從遊戲視窗左側算起的百分比位置 (0-100，預設 25)',
    'settings.wine.ime_pos_y': '候選字視窗 Y 位置 (%)',
    'settings.wine.ime_pos_y_help': '從遊戲視窗頂部算起的百分比位置 (0-100，預設 85)',
  ...
  'en-US': {
    ...
    'settings.discord_rpc.title': 'Discord Rich Presence',
    'settings.discord_rpc.enabled': 'Enable in-game Discord Rich Presence',
    'settings.discord_rpc.enabled_help': 'When enabled, Dalamud.RichPresence becomes the in-game activity producer (save/apply first)',
    'settings.discord_rpc.auto_install': 'Auto install/repair before launch',
    'settings.discord_rpc.auto_install_help': 'Automatically check and repair bridge before launching the game',
    'settings.discord_rpc.install_button': 'Install/Repair Bridge',
    'settings.discord_rpc.installing': 'Installing Discord RPC bridge...',
    'settings.discord_rpc.install_success': 'Discord RPC bridge installed successfully',
    'settings.discord_rpc.install_failed': 'Failed to install Discord RPC bridge',
    'settings.discord_rpc.status_unknown': 'Status: not checked yet',
    'settings.discord_rpc.status_unsupported': 'Status: unsupported on current platform',
    'settings.discord_rpc.status_disabled': 'Status: disabled',
    'settings.discord_rpc.status_ready': 'Status: ready',
    'settings.discord_rpc.status_needs_install': 'Status: installation or repair required',
    'settings.discord_rpc.status_pending_apply': 'Status: save/apply settings before install or repair',
    ...
    'settings.wine.ime_section': 'Input Method',
    'settings.wine.ime_pos_x': 'Candidate Window X Position (%)',
    'settings.wine.ime_pos_x_help': 'Percentage from left edge of game window (0-100, default 25)',
    'settings.wine.ime_pos_y': 'Candidate Window Y Position (%)',
    'settings.wine.ime_pos_y_help': 'Percentage from top edge of game window (0-100, default 85)',
