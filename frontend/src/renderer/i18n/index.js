...
const translations = {
  'zh-TW': {
    ...
    'settings.proton.graphics': '圖形設定',
    'settings.proton.dxvk_hud': 'DXVK HUD 顯示',
    'settings.proton.dxvk_hud_help': '顯示 DXVK 效能監控資訊',
    'settings.proton.max_framerate': '最高幀率',
    'settings.proton.max_framerate_help': '限制最高 FPS (30-240)',
    'settings.proton.performance': '效能設定',
    'settings.proton.gamemode': '啟用 GameMode',
    'settings.proton.gamemode_help': 'Feral GameMode 效能優化（需要安裝 gamemode 套件）',
    'settings.proton.advanced': '進階設定',
    'settings.proton.esync': 'Esync',
    'settings.proton.esync_help': '事件同步機制，提升多執行緒效能',
    'settings.proton.fsync': 'Fsync',
    'settings.proton.fsync_help': '快速同步機制（需要 Linux 核心 5.16+）',
    'settings.proton.wine_debug': 'Wine Debug',
    'settings.proton.wine_debug_help': 'Wine 除錯旗標（進階使用者，例如：-all,+module）',
  ...
  'en-US': {
    ...
    // Proton settings (Linux)
    'settings.proton.graphics': 'Graphics Settings',
    'settings.proton.dxvk_hud': 'DXVK HUD Display',
    'settings.proton.dxvk_hud_help': 'Show DXVK performance overlay',
    'settings.proton.max_framerate': 'Maximum Framerate',
    'settings.proton.max_framerate_help': 'Limit maximum FPS (30-240)',
    'settings.proton.performance': 'Performance Settings',
    'settings.proton.gamemode': 'Enable GameMode',
    'settings.proton.gamemode_help': 'Feral GameMode optimization (requires gamemode package)',
    'settings.proton.advanced': 'Advanced Settings',
    'settings.proton.esync': 'Esync',
    'settings.proton.esync_help': 'Event synchronization for better multi-threading',
    'settings.proton.fsync': 'Fsync',
    'settings.proton.fsync_help': 'Fast synchronization (requires Linux kernel 5.16+)',
    'settings.proton.wine_debug': 'Wine Debug',
    'settings.proton.wine_debug_help': 'Wine debug flags (advanced users, e.g., -all,+module)',
