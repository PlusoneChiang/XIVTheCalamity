...
const translations = {
  'zh-TW': {
    ...
    'settings.winexiv.max_framerate': '最高幀率',
    'settings.winexiv.max_framerate_help': '限制最高 FPS (30-240)',
    'settings.winexiv.performance': '效能設定',
    'settings.winexiv.gamemode': '啟用 GameMode',
    'settings.winexiv.gamemode_help': 'Feral GameMode 效能優化（需要安裝 gamemode 套件）',
    'settings.winexiv.advanced': '進階設定',
    'settings.winexiv.esync': 'Esync',
    'settings.winexiv.esync_help': '事件同步機制，提升多執行緒效能',
    'settings.winexiv.fsync': 'Fsync',
    'settings.winexiv.fsync_help': '快速同步機制（需要 Linux 核心 5.16+）',
    'settings.winexiv.wine_debug': 'Wine Debug',
    'settings.winexiv.wine_debug_help': 'Wine 除錯旗標（進階使用者，例如：-all,+module）',
  ...
  'en-US': {
    ...
    'settings.winexiv.max_framerate': 'Maximum Framerate',
    'settings.winexiv.max_framerate_help': 'Limit maximum FPS (30-240)',
    'settings.winexiv.performance': 'Performance Settings',
    'settings.winexiv.gamemode': 'Enable GameMode',
    'settings.winexiv.gamemode_help': 'Feral GameMode optimization (requires gamemode package)',
    'settings.winexiv.advanced': 'Advanced Settings',
    'settings.winexiv.esync': 'Esync',
    'settings.winexiv.esync_help': 'Event synchronization for better multi-threading',
    'settings.winexiv.fsync': 'Fsync',
    'settings.winexiv.fsync_help': 'Fast synchronization (requires Linux kernel 5.16+)',
    'settings.winexiv.wine_debug': 'Wine Debug',
    'settings.winexiv.wine_debug_help': 'Wine debug flags (advanced users, e.g., -all,+module)',
